      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="flex justify-between items-baseline mb-6">
          <div>
            ...
            <h2 className="text-2xl font-bold tracking-tight text-text">制作実績</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-5 md:gap-6">
          ...
          <div className="md:row-span-2">
            ...
            <div className="pt-3">
              ...
              <h3 className="text-base font-semibold leading-snug text-text">{featured.title}</h3>
              <p className="text-sm text-text-muted mt-1">{featured.subtitle}</p>
            </div>
          </div>
          ...
          {rest.map((work) => (
            <div key={work.id}>
              ...
              <div className="pt-2.5">
                ...
                <h3 className="text-sm font-semibold text-text">{work.title}</h3>
              </div>
            </div>
          ))}
        </div>
